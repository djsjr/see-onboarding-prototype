window.SEE_ONBOARDING_FLOW = (() => {
  ...
  return {
    ...
    screens: {
      ...
      downsides: {
        title: {
          less: "What is Alcohol Costing You?",
          stop: "What is Alcohol Costing You?",
        },
        subtitle: {
          less: "Pick all that apply.",
          stop: "Pick all that apply.",
        },
        options: {
          less: [
    ...
    overview: [
      ...
      { screen: "grip", label: "7" },
      { screen: "sleep", label: "8" },
      { screen: "energy", label: "9" },
      { screen: "focus", label: "10" },
      { screen: "memory", label: "11" },
      { screen: "relationships", label: "12" },
    ],
  };
})();
